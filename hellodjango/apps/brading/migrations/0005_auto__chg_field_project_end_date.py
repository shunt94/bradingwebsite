...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'brading_project', 'end_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Project.end_date'
        db.alter_column(u'brading_project', 'end_date', self.gf('django.db.models.fields.DateField')(default=None))
