...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Skill.option'
        db.add_column(u'brading_skill', 'option',
                      self.gf('django.db.models.fields.CharField')(default='Development', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Skill.option'
        db.delete_column(u'brading_skill', 'option')
