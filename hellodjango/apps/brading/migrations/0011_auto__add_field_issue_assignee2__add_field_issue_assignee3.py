...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.assignee2'
        db.add_column(u'brading_issue', 'assignee2',
                      self.gf('django.db.models.fields.CharField')(default='Unassigned', max_length=20),
                      keep_default=False)

        # Adding field 'Issue.assignee3'
        db.add_column(u'brading_issue', 'assignee3',
                      self.gf('django.db.models.fields.CharField')(default='Unassigned', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Issue.assignee2'
        db.delete_column(u'brading_issue', 'assignee2')

        # Deleting field 'Issue.assignee3'
        db.delete_column(u'brading_issue', 'assignee3')
    ...
    models = {
        ...
        u'brading.issue': {
            ...
            'time_spent': ('django.db.models.fields.IntegerField', [], {'default': '0.0', 'blank': 'True'}),
