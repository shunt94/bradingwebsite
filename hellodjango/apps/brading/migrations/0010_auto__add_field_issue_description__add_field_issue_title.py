...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.description'
        db.add_column(u'brading_issue', 'description',
                      self.gf('django.db.models.fields.TextField')(default='empty'),
                      keep_default=False)

        # Adding field 'Issue.title'
        db.add_column(u'brading_issue', 'title',
                      self.gf('django.db.models.fields.CharField')(default='empty', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Issue.description'
        db.delete_column(u'brading_issue', 'description')

        # Deleting field 'Issue.title'
        db.delete_column(u'brading_issue', 'title')
